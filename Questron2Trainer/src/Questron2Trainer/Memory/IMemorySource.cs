...
/// <summary>
/// The read-only slice of a target process that <see cref="CharacterLocator"/> needs.
/// This exists so the locator can be driven from a fixture in the verification harness.
/// </summary>
