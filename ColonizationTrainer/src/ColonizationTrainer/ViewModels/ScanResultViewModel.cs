...
/// <summary>
/// One surviving candidate from a value scan: an address and the value last read there. Read-only in
/// the grid — the user narrows the candidate set with follow-up scans, then pins a survivor to the
/// freeze table to edit it.
/// </summary>
