...
/// weapons — a compact damage/range/fire-mode line.
/// </summary>
...
/// <summary>
/// The full Wasteland item table (ids 1..94). Items are stored in the packed inventory array as
/// (itemId, ammo/qty) byte pairs — the same format as the original DOS game. Categories are a
/// display grouping; ids 70..72 are unused.
/// </summary>
public static class ItemBook
{
    ...
    /// <summary>
    /// True when an item's quantity byte is ammunition Freeze Ammo should top up.
    /// </summary>
