...
/// <see cref="CharacterFormat.AttributeNames"/>), the abbreviation shown in the UI, the full
/// name, what the game uses it for, and a practical build note.
/// </summary>
...
/// <summary>
/// Reference descriptions of Wasteland's seven attributes. Ordered to match
/// <see cref="CharacterFormat.AttributeNames"/> exactly (STR, IQ, LCK, SPD, AGL, DEX, CHR).
/// </summary>
