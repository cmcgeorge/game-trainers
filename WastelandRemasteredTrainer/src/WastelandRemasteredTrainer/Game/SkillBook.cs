...
/// paraphrase of what it does in play, and where in the game it's notably used.
/// </summary>
...
/// <summary>
/// Reference table of Wasteland's 35 skills, keyed by the skill id stored in the packed skill
/// array. Ids and names match the original game; the SkillEnum type in the remaster's metadata
/// confirms the same ids (S_BRAWLING = 1 through S_CYBORGTECH = 35).
/// </summary>
