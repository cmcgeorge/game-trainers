...
public static class ScanValue
{
    ...
    /// the unsigned range pass through unchanged. Pirates! keeps its player fields unsigned — gold
    /// saturates at 0xFFFF rather than going negative — so folding matters mainly when a user types a
    /// negative probe by hand.
    /// </summary>
