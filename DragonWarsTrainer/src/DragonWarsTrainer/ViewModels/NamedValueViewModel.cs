...
/// <summary>
/// A labelled, editable integer backed by getter/setter delegates onto a character record —
/// used for the per-attribute and per-skill rows. The setter writes through to live memory.
/// </summary>
