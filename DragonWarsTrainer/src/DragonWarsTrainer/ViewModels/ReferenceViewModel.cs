...
/// <summary>
/// Backs the References tab's read-only sub-tabs (Spells, Skills, Items, Monsters, Strategy). Every
/// collection is a static reference table from the <c>Game/</c> layer; the spell and item views are
/// grouped (by magic school / item category) for the grouped list templates. Drives no memory writes.
/// </summary>
