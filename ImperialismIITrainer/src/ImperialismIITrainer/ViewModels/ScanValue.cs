...
public static class ScanValue
{
    ...
    /// the unsigned range pass through unchanged. Imperialism II's treasury is a signed 32-bit value
    /// that goes negative in debt, so folding matters for a debt-recovery scan.
    /// </summary>
