...
{
#if DEBUG
    // DEBUG-only: with S1889_SMOKETEST set, load the window, walk every tab so all the
    ...
    private static readonly string? SmokeTestMarker = Environment.GetEnvironmentVariable("S1889_SMOKETEST");
#endif
    ...
    private void OnDispatcherUnhandledException(object sender, DispatcherUnhandledExceptionEventArgs e)
    {
        ...
        // it was doing -- a partial character edit, a half-applied freeze -- did not finish. The
        ...
        var choice = MessageBox.Show(
            ...
            "editing anything.\n\nDetails written to:\n" + log +
            "\n\nClose the trainer?",
            "Space 1889 Trainer", MessageBoxButton.YesNo, MessageBoxImage.Error);
        e.Handled = true;
