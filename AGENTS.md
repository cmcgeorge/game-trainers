...
- `AutoduelTrainer/`, `BardsTale1Trainer/`, `DragonWarsTrainer/`, `KeefTrainer/`, `LordsOfTheRealmTrainer/`, `MightAndMagic1Trainer/`, `MinesOfTitanTrainer/`, `PoolOfRadianceTrainer/`, `ShogunTrainer/`, `SwordOfTheSamuraiTrainer/`, `SyndicatePlusTrainer/`, `WarOfTheLanceTrainer/`.
