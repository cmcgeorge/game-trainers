...
/// <summary>
/// Reference descriptions of Curse of the Azure Bonds's six primary abilities, exceptional strength, and
/// hit points: what each does in the game and how it matters when building a character. The role
/// text follows AD&amp;D 1st-edition rules (the system Curse of the Azure Bonds implements); the in-play
/// notes follow the bundled strategy guide (<c>.docs</c>). Reference only — nothing here is
/// written to the game.
///
/// The list is ordered to match <see cref="CoabFormat.Stats"/>/ <see cref="CoabFormat.StatsShort"/>
