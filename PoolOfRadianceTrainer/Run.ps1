...
<#
.SYNOPSIS
    Builds and launches the Pool of Radiance trainer.
...
$exeName     = 'PoRTrainer.exe'
$exePath     = Join-Path $root "src\PoolOfRadianceTrainer\bin\$Configuration\net8.0-windows\PoRTrainer.exe"
$binConfigDir = 'bin'
$buildArgs   = @()
$launchHint  = 'Launch Pool of Radiance in DOSBox, then Attach in the trainer.'
# ------------------------------------------------------------------------------
