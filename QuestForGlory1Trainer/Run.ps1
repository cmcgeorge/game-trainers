<#
.SYNOPSIS
    Builds and launches the Quest for Glory I trainer.
...
$root        = $PSScriptRoot
$project     = Join-Path $root 'src\QuestForGlory1Trainer\QuestForGlory1Trainer.csproj'
$testProject = $null
$exeName     = 'QuestForGlory1Trainer.exe'
$exePath     = Join-Path $root "src\QuestForGlory1Trainer\bin\$Configuration\net8.0-windows\QuestForGlory1Trainer.exe"
$binConfigDir = 'bin'
$buildArgs   = @()
$launchHint  = 'Launch Quest for Glory I in DOSBox, then Attach in the trainer.'
# ------------------------------------------------------------------------------
...
if (-not (Test-Path -LiteralPath $project)) {
    throw "Project not found at '$project'. Run this script from the QuestForGlory1Trainer folder."
}
