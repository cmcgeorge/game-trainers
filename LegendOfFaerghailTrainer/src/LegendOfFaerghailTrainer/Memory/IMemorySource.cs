...
/// <summary>
/// The read-only slice of a target process that <see cref="GameLocator"/> needs. It exists so the
/// locator can be driven from a synthetic address space in the verification harness, with no
/// emulator and no copyrighted game files present.
/// </summary>
