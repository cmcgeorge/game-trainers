...
<#
.SYNOPSIS
    Builds and launches the Bard's Tale 1 trainer.
...
$exeName     = 'BT1Trainer.exe'
$exePath     = Join-Path $root "src\BardsTale1Trainer\bin\$Configuration\net8.0-windows\BT1Trainer.exe"
$binConfigDir = 'bin'
$buildArgs   = @()
